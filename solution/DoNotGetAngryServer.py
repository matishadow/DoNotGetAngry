...
class GameServer:
    def __init__(self):
        self.commands = ["sconnect_to_lobby", "sset_ready", "supdate_user_decision_callback",
                         "supdate_user_counter_choosen_callback",
                         "supdate_dice_confirm_callback"]  # , "check_state", "list_lobby", "list_ready", "set_ready","start_game", "check_board", "check_dice", "check_current_color", "move"]
        self.odatalock = Lock()
        self.odata = None
        #
        self.lobby = []
        ...
        while True:
            ...
            try:
                end_of_game = self.g.turn(self.suserdecision_callback, self.suser_counter_choosen_callback,
                                          self.suser_dice_confirm_callback)
            except:
                print("turn error")
            finally:
                pass
