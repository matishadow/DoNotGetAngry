...
class LayoutControlsInserter:
    ...
    def insert_controls(layout, dialog):
        ...
        layout.home_tiles = [layout.blue_home_tile_0, layout.blue_home_tile_1, layout.blue_home_tile_2, layout.blue_home_tile_3, layout.red_home_tile_0, layout.red_home_tile_1, layout.red_home_tile_2, layout.red_home_tile_3, layout.green_home_tile_0, layout.green_home_tile_1, layout.green_home_tile_2, layout.green_home_tile_3, layout.yellow_home_tile_0, layout.yellow_home_tile_1, layout.yellow_home_tile_2, layout.yellow_home_tile_3]
        layout.starting_tiles = [layout.blue_starting_tile_0, layout.blue_starting_tile_1, layout.blue_starting_tile_2, layout.blue_starting_tile_3, layout.red_starting_tile_0, layout.red_starting_tile_1, layout.red_starting_tile_2, layout.red_starting_tile_3, layout.green_starting_tile_0, layout.green_starting_tile_1, layout.green_starting_tile_2, layout.green_starting_tile_3, layout.yellow_starting_tile_0, layout.yellow_starting_tile_1, layout.yellow_starting_tile_2, layout.yellow_starting_tile_3]
